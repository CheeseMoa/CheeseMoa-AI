...
[ADR 012](docs/decisions/012-merge-threshold-recalibration.md) AND 파편 간 face-pair 평균 바닥 0.45 —
...
- **파편병합 face-level 응집 게이트 — 아동 교차연령 오병합 해소** (2026-07-16, CHMO-269,
  ...
  바닥**(`merge_facepair_floor=0.45`)을 centroid와 AND로 추가. 라벨 코퍼스 child 8인 ARI 0.245→0.788
